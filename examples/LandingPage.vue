<template>
  <header id="header" class="ui icon header grid">
    <div class="three wide column">
      <h1 class="ui header">
        <a href="https://mtg.github.io/essentia.js/" target="_blank">
          <svg viewBox="25 0 285 50" fill="none" xmlns="http://www.w3.org/2000/svg" >
  ...
  <main class="ui grid" id="tabular-card-menu">
    ...
    <div class="thirteen wide column" id="tab-view-container">
      ...
      <div class="ui tab segment" data-tab="glitch-melspectrogram">
        <a href="https://glitch.com/edit/#!/essentiajs-melspectrogram">see on glitch</a>
      </div>
      <div class="ui tab segment" data-tab="glitch-pitch-melodia" >
        <a href="https://glitch.com/edit/#!/essentiajs-pitchmelodia"></a>
      </div>
      <div class="ui tab segment" data-tab="glitch-hpcp-chroma">
        <a href="https://glitch.com/edit/#!/essentiajs-hpcpc-chroma"></a>
      </div>
      <div class="ui tab segment" data-tab="glitch-autotagging">
  ...
  <footer class="ui centered aligned container" id="my-footer">
    <a target="_blank" href="//essentia.upf.edu">
      <img id="logo" src="https://raw.githubusercontent.com/MTG/mtg-logos/master/essentia/essentia-RGB.svg" alt="MTG Logo"
        style="height: 70px;">
    </a>
    <a target="_blank" href="https://www.upf.edu/web/mtg">
      <img src="https://raw.githubusercontent.com/MTG/mtg-logos/master/mtg/MTG_CMYK_logo-05.svg" alt="mtg logo"
...
const selectedDemoName = computed(() => {
  return route.name;
});
</script>
...
<style scoped>
  ...
  #header h1 .sub.header {
    font-family: "Myriad Bold", "Helvetica Neue", Arial, Helvetica, sans-serif;
    font-size: 1.25rem;
  }
