...
EMSCRIPTEN_BINDINGS(Class_Extractor) { 
  class_<FullSignalTFInputMusiCNN>("FullSignalTFInputMusiCNN")
    .constructor()
    .property("version", &FullSignalTFInputMusiCNN::essentiaVersion)
    .function("compute", &FullSignalTFInputMusiCNN::compute)
    .function("shutdown", &FullSignalTFInputMusiCNN::shutdown)
    ;
